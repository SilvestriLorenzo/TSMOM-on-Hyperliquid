...
Probability 41:147-161 (full text at cs.rpi.edu/~magdon/ps/journal/drawdown_journal.pdf,
also saved locally: research/output/papers/magdon_ismail_atiya_2004.pdf). User-cited as
the sizing framework for H_TSMOM (session 10).
